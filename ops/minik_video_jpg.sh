...
python3 video_jpg.py /MD1400/jhseon/datasets/minik/compress/train_256 /MD1400/jhseon/datasets/minik/images/train --file_list /MD1400/jhseon/datasets/minik/mini_train_split.txt --dataset minik --parallel | tee tmp_train_log.txt
python3 video_jpg.py /MD1400/jhseon/datasets/minik/compress/val_256 /MD1400/jhseon/datasets/minik/images/val --file_list /MD1400/jhseon/datasets/minik/mini_val_split.txt --dataset minik --parallel | tee tmp_train_log.txt
