...
python main_base.py actnet RGB --arch resnet18 --num_segments 16 --gd 20 --lr 0.001 --wd 1e-4 --lr_steps 20 40 --epochs 15 --batch-size 48 --dropout 0.5 --consensus_type=avg --eval-freq=1 --npb --gpus 0 1 2 3 --exp_header actnet_res18_t16_epo10_112_lr.001 --rescale_to 112 -j 36 --data_dir ../datasets/activity-net-v1.3 --log_dir ../logs_tsm --workers 4
