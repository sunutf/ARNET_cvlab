...
# TODO A-2. joint training for 100 epochs (replace the GGGG with the real datetime shown in your exp dir)
python main_base.py actnet RGB --arch resnet50 --num_segments 16 --lr 0.001 --epochs 200  --batch-size 24 --repeat_batch 2 --lr_steps 100 200 -j 32 --npb --gpus 0 1 2 3  --exp_header jact4_t16_3m124_a.95e.05_ed5_ft15ds_lr.003_gu3_ep100 --ada_depth_skip --amd_consensus_type random_avg  --use_conf_btw_blocks  --rescale_to 192 --block_rnn_list conv_2 conv_3 conv_4 conv_5 --accuracy_weight 0.95 --efficency_weight 0.05 --model_paths ../logs_tsm/g0222-010807_actnet_res50_t16_epo15_192_lr.001/models/ckpt.best.pth.tar --exp_decay --init_tau 5.0  --uniform_loss_weight 0.0 --use_gflops_loss --random_seed 1007 --data_dir ../datasets/activity-net-v1.3 --log_dir ../logs_tsm   
