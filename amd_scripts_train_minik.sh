...
#python main_base.py actnet RGB --arch resnet50 --num_segments 16 --lr 0.001 --epochs 100 --batch-size 24 -j 32 --npb --gpus 0 1 2 3 --exp_header jact4_t16_3m124_a.95e.05_ed5_ft15ds_lr.003_gu3_ep100 --ada_depth_skip --use_kld_loss --diff_to_policy  --block_rnn_list conv_2 conv_3 conv_4 conv_5 --accuracy_weight 0.9 --efficency_weight 0.1 --model_paths ../logs_tsm/g1221-040831_actnet_res50_t16_epo15_224_lr.001/models/ckpt.best.pth.tar --exp_decay --init_tau 5 --uniform_loss_weight 0.0 --use_gflops_loss --random_seed 1007 --data_dir ../../datasets/activity-net-v1.3 --log_dir ../logs_tsm  
